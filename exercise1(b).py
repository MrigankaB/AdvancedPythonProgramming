...
print("Dimension of the resultant matrix A+B is ",C.ndim)
print("Shape of A+B: ",C.shape)
print("size of A+B: ",C.size,"elements")
print("Data type of A+B: ",C.dtype)
print("Each element of A+B takes",C.itemsize,"bytes")